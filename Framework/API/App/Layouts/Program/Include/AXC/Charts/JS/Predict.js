        ...
        $.post("http://127.0.0.0/Local-Server-Website/Framework/API/App/Layouts/Program/Include/AXC/Charts/HTML/ImagesCaptured/Data.php",
            function (data)
            {
                ...
                for (var i in data) {
                    ...
                    // Database
                    TakenMarks.push(data[i].Taken * .5);
                    InDatabaseMarks.push(data[i].In_Database * .5);
                    NotInDatabaseMarks.push(data[i].Not_In_Database * .5);
                    // Averages
                    ...
                    // Devices
                    GoProDevices.push(data[i].GoPro * .5);
                    DroneDevices.push(data[i].Drone * .5);
                    PhoneDevices.push(data[i].Phone * .5);
                }
                var alldata = {
                    labels: name,
                    datasets: [{
